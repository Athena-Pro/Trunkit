...
├──────────────────────────┼───────────────────────────────────────┤
│  curry                   │  calx                                  │
│  versioned provenance    │  + immutable constants                 │
│  + immutable constants   │  integer arithmetic bedrock            │
└──────────────────────────┴───────────────────────────────────────┘
...
# 2. Apply all schemas (idempotent — safe to re-run)
make apply
...
# 5. Porter: pre-pack a morning brief and open it as Model B
